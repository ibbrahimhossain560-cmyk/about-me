      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="max-w-4xl mx-auto space-y-8 mb-24">
          <Card className="animate-fade-in-up group hover:shadow-xl hover:shadow-accent/20 transition-all duration-500 hover:-translate-y-1 hover:scale-[1.02] cursor-pointer">
            <CardHeader>
              <CardTitle className="text-2xl group-hover:text-primary transition-colors duration-300">Full Stack Developer (Self-taught)</CardTitle>
              <p className="text-foreground/70">Personal Projects & Freelance — 2023 — Present</p>
            </CardHeader>
            <CardContent>
              <p className="text-foreground/80">
                Built multiple full stack web applications using React, Node.js, MongoDB, and Firebase. 
                Focused on user authentication, payment systems, and clean UI/UX.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="animate-fade-in-up group hover:shadow-xl hover:shadow-accent/20 transition-all duration-500 hover:-translate-y-1 hover:scale-[1.02] cursor-pointer" style={{ animationDelay: '150ms' }}>
            <CardHeader>
              <CardTitle className="text-2xl group-hover:text-primary transition-colors duration-300">Open Source Contributor</CardTitle>
              <p className="text-foreground/70">GitHub Projects — 2023 — Present</p>
            </CardHeader>
            <CardContent>
              <p className="text-foreground/80">
                Contributed to open-source React components, fixed bugs, and collaborated with developers 
